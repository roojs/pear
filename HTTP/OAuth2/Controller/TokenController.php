        ...
        if (is_null($clientAssertionType)) {
            foreach ($grantTypes as $grantType) {
                if (!$grantType instanceof ClientAssertionTypeInterface) {
                    throw new \InvalidArgumentException('You must supply an instance of OAuth2\ClientAssertionType\ClientAssertionTypeInterface or only require_once 'HTTP/grant types which implement OAuth2/ClientAssertionType/HTTP_OAuth2_ClientAssertionTypeInterface')';
                }
            }
        }
