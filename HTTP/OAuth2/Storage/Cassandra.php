...
require_once 'HTTP/phpcassa/HTTP_OAuth2_ColumnFamily';
require_once 'HTTP/phpcassa/HTTP_OAuth2_ColumnSlice';
require_once 'HTTP/phpcassa/Connection/HTTP_OAuth2_ConnectionPool';
...
HTTP_OAuth2_ *  $storage->setClientDetails($client_id, $client_secret, $redirect_uri)';
 * </code>
 *
