...
require_once 'HTTP/OAuth2/Encryption/HTTP_OAuth2_EncryptionInterface';
require_once 'HTTP/OAuth2/Encryption/HTTP_OAuth2_Jwt';
require_once 'HTTP/OAuth2/Storage/HTTP_OAuth2_AccessTokenInterface';
require_once 'HTTP/OAuth2/Storage/HTTP_OAuth2_RefreshTokenInterface';
require_once 'HTTP/OAuth2/Storage/HTTP_OAuth2_PublicKeyInterface';
require_once 'HTTP/OAuth2/Storage/HTTP_OAuth2_Memory';
