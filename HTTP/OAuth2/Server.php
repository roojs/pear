...
require_once 'HTTP/OAuth2/Controller/HTTP_OAuth2_Controller_AuthorizeControllerInterface';
require_once 'HTTP/OAuth2/Controller/HTTP_OAuth2_Controller_AuthorizeController';
require_once 'HTTP/OAuth2/Controller/HTTP_OAuth2_Controller_TokenControllerInterface';
require_once 'HTTP/OAuth2/Controller/HTTP_OAuth2_Controller_TokenController';
require_once 'HTTP/OAuth2/ClientAssertionType/HTTP_OAuth2_ClientAssertionType_ClientAssertionTypeInterface';
require_once 'HTTP/OAuth2/ClientAssertionType/HTTP_OAuth2_ClientAssertionType_HttpBasic';
require_once 'HTTP/OAuth2/ResponseType/HTTP_OAuth2_ResponseType_ResponseTypeInterface';
require_once 'HTTP/OAuth2/ResponseType/HTTP_OAuth2_ResponseType_AuthorizationCode';
require_once 'HTTP/OAuth2/ResponseType/HTTP_OAuth2_ResponseType_AccessToken';
require_once 'HTTP/OAuth2/ResponseType/HTTP_OAuth2_ResponseType_CryptoToken';
require_once 'HTTP/OAuth2/OpenID/ResponseType/HTTP_OAuth2_OpenID_ResponseType_IdToken';
require_once 'HTTP/OAuth2/OpenID/ResponseType/HTTP_OAuth2_OpenID_ResponseType_TokenIdToken';
require_once 'HTTP/OAuth2/TokenType/HTTP_OAuth2_TokenType_TokenTypeInterface';
require_once 'HTTP/OAuth2/TokenType/HTTP_OAuth2_TokenType_Bearer';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_GrantType_GrantTypeInterface';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_GrantType_UserCredentials';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_GrantType_ClientCredentials';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_GrantType_RefreshToken';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_GrantType_AuthorizationCode';
require_once 'HTTP/OAuth2/Storage/HTTP_OAuth2_Storage_CryptoToken';
require_once 'HTTP/OAuth2/Storage/HTTP_OAuth2_Storage_CryptoTokenInterface';
