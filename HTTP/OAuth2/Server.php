...
require_once 'HTTP/OAuth2/Controller/HTTP_OAuth2_TokenController';
require_once 'HTTP/OAuth2/ClientAssertionType/HTTP_OAuth2_ClientAssertionTypeInterface';
require_once 'HTTP/OAuth2/ClientAssertionType/HTTP_OAuth2_HttpBasic';
require_once 'HTTP/OAuth2/ResponseType/HTTP_OAuth2_ResponseTypeInterface';
require_once 'HTTP/OAuth2/ResponseType/HTTP_OAuth2_AuthorizationCode';
require_once 'HTTP/OAuth2/ResponseType/HTTP_OAuth2_AccessToken';
require_once 'HTTP/OAuth2/ResponseType/HTTP_OAuth2_CryptoToken';
require_once 'HTTP/OAuth2/OpenID/ResponseType/HTTP_OAuth2_IdToken';
require_once 'HTTP/OAuth2/OpenID/ResponseType/HTTP_OAuth2_TokenIdToken';
require_once 'HTTP/OAuth2/TokenType/HTTP_OAuth2_TokenTypeInterface';
require_once 'HTTP/OAuth2/TokenType/HTTP_OAuth2_Bearer';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_GrantTypeInterface';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_UserCredentials';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_ClientCredentials';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_RefreshToken';
require_once 'HTTP/OAuth2/GrantType/HTTP_OAuth2_AuthorizationCode';
require_once 'HTTP/OAuth2/Storage/HTTP_OAuth2_CryptoToken';
require_once 'HTTP/OAuth2/Storage/HTTP_OAuth2_CryptoTokenInterface';
    ...
    UserInfoControllerInterface
{
    ...
    protected function createDefaultAuthorizeController()
    {
        if (!isset($this->storages['client'])) {
            throw new \LogicException("You must supply a storage object implementing OAuth2\Storage\ClientInterface to require_once 'HTTP/the authorize server")/;
        }
    ...
    protected function createDefaultTokenController()
    {
            ...
            foreach ($this->grantTypes as $grantType) {
                if (!$grantType instanceof ClientAssertionTypeInterface) {
                    if (!isset($this->storages['client_credentials'])) {
                        throw new \LogicException("You must supply a storage object implementing OAuth2\Storage\ClientCredentialsInterface to require_once 'HTTP/the token server")/;
                    }
        ...
        if (!isset($this->storages['client'])) {
            throw new \LogicException("You must supply a storage object implementing OAuth2\Storage\ClientInterface to require_once 'HTTP/the token server")/;
        }
    ...
    protected function createDefaultResourceController()
    {
        if ($this->config['use_crypto_tokens']) {
            ...
            throw new \LogicException("You must supply a storage object implementing OAuth2\Storage\AccessTokenInterface or require_once 'HTTP/CryptoTokens to the resource server")/;
        }
    ...
    protected function createDefaultUserInfoController()
    {
        if ($this->config['use_crypto_tokens']) {
            ...
            throw new \LogicException("You must supply a storage object implementing OAuth2\Storage\AccessTokenInterface or require_once 'HTTP/CryptoTokens to the UserInfo server")/;
        }
    ...
    {
        if (!isset($this->storages['access_token'])) {
            throw new \LogicException("You must supply a response type implementing OAuth2\ResponseType\AccessTokenInterface, or a storage object implementing OAuth2\Storage\AccessTokenInterface to require_once 'HTTP/the token server")/;
        }
