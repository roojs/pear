...
require_once 'HTTP/OAuth2/OpenID/ResponseType/TokenIdTokenInterface.php';

class HTTP_OAuth2_OpenID_ResponseType_TokenIdToken implements HTTP_OAuth2_OpenID_ResponseType_TokenIdTokenInterface
{
