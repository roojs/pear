...
class HTML_Clean {
    ...
    {
        $str = "<body lang='ar'><h1>aaa</h1><P></P><a href='#aaa'><b>test</b></a><p dir='ltr'><b>Hello</b></p><span dir='rtl'>World</span></body>";
    ...
    function __construct($opts)
    {
        ...
        $this->filter('Empty',array( 'node' =>  $d, 'tags' => array('B', 'I', 'U', 'S') ));
        $result = '';
