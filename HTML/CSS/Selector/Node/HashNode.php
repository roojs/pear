 ...
 */
class HTML_CSS_Selector_Node_HashNode implements HTML_CSS_Selector_Node_NodeInterface
{
    protected $selector;
    protected $id;
    ...
    public function toXpath()
    {
        ...
        $path->addCondition(sprintf('@id = %s', HTML_CSS_Selector_XPathExpr::xpathLiteral($this->id)));
