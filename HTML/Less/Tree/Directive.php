 ...
 * @subpackage tree
 */
class HTML_Less_Tree_Directive extends HTML_Less_Tree {
    ...
    public function genCSS($output) {
        ...
        if ($this->rules) {
            HTML_Less_Tree::outputRuleset($output, array($this->rules));
        } else {
            $output->add(';');
        }
    }
    ...
    public function compile($env) {
        ...
        return new HTML_Less_Tree_Directive($this->name, $value, $rules, $this->index, $this->currentFileInfo, $this->debugInfo);
    }
    ...
    public function markReferenced() {
        ...
        if ($this->rules) {
            HTML_Less_Tree::ReferencedArray($this->rules->rules);
        }
    }
