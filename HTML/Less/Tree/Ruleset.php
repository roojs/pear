 ...
 * @subpackage tree
 */
class HTML_Less_Tree_Ruleset extends HTML_Less_Tree {
    ...
    public function compile($env) {
        ...
        for ($i = 0; $i < $rsRuleCnt; $i++) {
            if ($ruleset->rules[$i] instanceof HTML_Less_Tree_Mixin_Definition || $ruleset->rules[$i] instanceof HTML_Less_Tree_DetachedRuleset) {
