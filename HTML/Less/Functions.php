...
class HTML_Less_Functions {
    ...
    public function screen($color1 = null, $color2 = null) {
        if (!$color1 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The first argument to screen must be a color' . ($color1 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
        if (!$color2 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The second argument to screen must be a color' . ($color2 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
    ...
    public function overlay($color1 = null, $color2 = null) {
        if (!$color1 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The first argument to overlay must be a color' . ($color1 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
        if (!$color2 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The second argument to overlay must be a color' . ($color2 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
    ...
    public function exclusion($color1 = null, $color2 = null) {
        if (!$color1 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The first argument to exclusion must be a color' . ($color1 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
        if (!$color2 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The second argument to exclusion must be a color' . ($color2 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
    ...
    public function average($color1 = null, $color2 = null) {
        if (!$color1 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The first argument to average must be a color' . ($color1 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
        if (!$color2 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The second argument to average must be a color' . ($color2 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
    ...
    public function negation($color1 = null, $color2 = null) {
        if (!$color1 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The first argument to negation must be a color' . ($color1 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
        if (!$color2 instanceof HTML_Less_Tree_Color) {
            throw new HTML_Less_Exception_Compiler('The second argument to negation must be a color' . ($color2 instanceof HTML_Less_Tree_Expression ? ' (did you forgot commas?)' : ''));
        }
