...
class Net_XMPP_BOSH extends Net_XMPP 
{
    ...
    {
        if (isset($_SESSION['Net_XMPP_BOSH_RID'])){
            $this->rid = $_SESSION['Net_XMPP_BOSH_RID'];
        }
        
        if (isset($_SESSION['Net_XMPP_BOSH_SID'])) {
            $this->sid = $_SESSION['Net_XMPP_BOSH_SID'];
        }
            
        if (isset($_SESSION['Net_XMPP_BOSH_authed'])) {
            $this->authed = $_SESSION['Net_XMPP_BOSH_authed'];
        }
            
        if (isset($_SESSION['Net_XMPP_BOSH_jid'])) {
            $this->jid = $_SESSION['Net_XMPP_BOSH_jid'];
        }
            
        if (isset($_SESSION['Net_XMPP_BOSH_fulljid'])) {
            $this->fulljid = $_SESSION['Net_XMPP_BOSH_fulljid'];
        }
    ...
    public function saveSession() {
        ...
        $_SESSION['Net_XMPP_BOSH_jid'] = (string) $this->jid;
        $_SESSION['Net_XMPP_BOSH_fulljid'] = (string) $this->fulljid;
    }
