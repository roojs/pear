	...
	*/
	class Net_EPP_Client {
		...
		*/
        ...
        function command($cmd, $opts=array(),$copts=array())
        {
            
            //var_dump($cmd);
            require_once 'Net/EPP/Frame/Command/'. $cmd .'.php';
            $cls = 'Net_EPP_Frame_Command_'. str_replace('/', '_', $cmd);
            //var_dump($cls);
            $ret = new $cls($opts, $copts);
            return $ret;
        }
