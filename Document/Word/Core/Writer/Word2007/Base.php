...
class Document_Word_Writer_Writer_Word2007_Base extends Document_Word_Writer_Writer_Word2007_WriterPart 
{
	...
	protected function _writeText(?Document_Word_Shared_XMLWriter $objWriter = null, Document_Word_Writer_Section_Text $text, $withoutP = false) 
        {
...
//		$strText = str_replace('&amp;', '&', $strText); // htmlspecialchars going overboard..
	...
	protected function _writeTextRun(?Document_Word_Shared_XMLWriter $objWriter = null, Document_Word_Writer_Section_TextRun $textrun) 
        {
	...
	protected function _writeParagraphStyle(?Document_Word_Shared_XMLWriter $objWriter = null, Document_Word_Writer_Style_Paragraph $style, $withoutPPR = false) 
        {
	...
	protected function _writeLink(?Document_Word_Shared_XMLWriter $objWriter = null, Document_Word_Writer_Section_Link $link, $withoutP = false) 
        {
	...
	protected function _writePreserveText(?Document_Word_Shared_XMLWriter $objWriter = null, Document_Word_Writer_Section_Footer_PreserveText $textrun, $skip_para = false) 
        {
	...
	protected function _writeTextBreak(?Document_Word_Shared_XMLWriter $objWriter = null) 
        {
	...
	protected function _writeTable(?Document_Word_Shared_XMLWriter $objWriter = null, Document_Word_Writer_Section_Table $table) 
        {
            $_rows = $table->getRows();
            $_cRows = count($_rows);
	...
	protected function _writeTableStyle(?Document_Word_Shared_XMLWriter $objWriter = null, ?Document_Word_Writer_Style_Table $style = null) 
        {
	...
	protected function _writeCellStyle(?Document_Word_Shared_XMLWriter $objWriter = null, ?Document_Word_Writer_Style_Cell $style = null) 
        {
	...
	function _writeImage(Document_Word_Shared_XMLWriter $objWriter, $image, $skip_para = false) 
    {
...
//		$objWriter->endElement();
	...
	protected function _writeWatermark(?Document_Word_Shared_XMLWriter $objWriter = null, $image) 
        {
		$rId = $image->getRelationId();
	...
	protected function _writeTitle(?Document_Word_Shared_XMLWriter $objWriter = null, Document_Word_Writer_Section_Title $title) 
        {
