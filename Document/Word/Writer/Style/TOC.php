 ...
 */
class Document_Word_Writer_Style_TOC 
{
	...
	public function __construct() 
        {
		$this->_tabPos      = 9062;
		$this->_tabLeader   = Document_Word_Writer_Style_TOC::TABLEADER_DOT;
		$this->_indent      = 200;
	}
	 ...
	 * @param string $pValue
	 */
	public function setTabLeader($pValue = Document_Word_Writer_Style_TOC::TABLEADER_DOT) 
        {
		$this->_tabLeader = $pValue;
	}
