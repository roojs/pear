 ...
 */
class Document_Word_Writer_Style_Font 
{
	...
	public function setUnderline($pValue = Document_Word_Writer_Style_Font::UNDERLINE_NONE) 
        {
		if ($pValue == '') {
			$pValue = Document_Word_Writer_Style_Font::UNDERLINE_NONE;
		}
	...
	public function setColor($pValue = 'ff0000') 
        {
	   $this->_color = $pValue;
	   return $this;
	}
